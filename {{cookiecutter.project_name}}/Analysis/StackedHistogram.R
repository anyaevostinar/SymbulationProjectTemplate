...
setwd("/Accounts/research/MutationMutualism/Symbulation/SymbulationEmp/Results/VMR0.1_SF2_VT0.5_HMR_SWEEP_30000")

first_try <- read.table("munged_histogram_host_0.5.dat", h=T)
...
combined <- subset(combined, treatment == "1")
